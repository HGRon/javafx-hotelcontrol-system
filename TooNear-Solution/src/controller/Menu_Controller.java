...
public class Menu_Controller implements Initializable {
    ...
    private void loadRegistroUi() throws IOException {
        Pane testePane = FXMLLoader.load(getClass().getResource("../fxml/Registro.fxml"));
        rootPane.getChildren().setAll(testePane);
    }

    @FXML
    private void loadReservaUi() throws IOException {
        Pane testePane = FXMLLoader.load(getClass().getResource("../fxml/Reserva.fxml"));
        rootPane.getChildren().setAll(testePane);
    }

    @FXML
    private void loadControleUi() throws IOException {
        Pane testePane = FXMLLoader.load(getClass().getResource("../fxml/Controle.fxml"));
        rootPane.getChildren().setAll(testePane);
    }
}
